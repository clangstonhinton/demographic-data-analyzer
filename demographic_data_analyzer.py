...
def calculate_demographic_data(print_data=True):
    ...
    lower_education = len(df) - len(df.loc[df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])])
    ...
    rich_percentage = int((len(df[(df['hours-per-week'] == 1) & (df['salary'] == '>50K')])) / num_min_workers *100)
